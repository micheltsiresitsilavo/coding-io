            ...
            <div className="grid gap-8 md:grid-cols-2">
              ...
              <div className="space-y-4">
                <div className="relative overflow-hidden rounded-lg bg-gray-100">
                  <img
                    src="https://www.elegantthemes.com/images/monarch/monarch-preview.jpg"
                    loading="lazy"
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="overflow-hidden rounded-lg bg-gray-100">
                    <img
                      src="https://www.elegantthemes.com/images/monarch/monarch-sharing-popup.jpg"
                      loading="lazy"
                      alt="Photo by Himanshu Dewangan"
                      className="h-full w-full object-cover object-center"
                    />
      ...
      <!-- content - start --> */}
        ...
        <!-- shipping notice - start --> */}
                <div className="mb-6 flex items-center gap-2 text-gray-500">
                  ...
                  <span className="text-sm">via un lien de téléchargement</span>
                </div>
                {/* <!-- shipping notice - end -->
        ...
        <!-- description - start --> */}
                <div className="mt-10 md:mt-16 lg:mt-20">
                  ...
                  <p className="text-gray-500">
                    Les médias sociaux sont l'élément vital qui fait rayonner
                    l'internet. Le partage social vous permet d'exploiter cette
                    activité et d'en faire une force positive pour votre
                    entreprise. Choisissez parmi plus de 20 réseaux de partage
                    social à afficher sur votre site web pour créer une
                    collection personnalisée d'options de partage pour vos
                    visiteurs.
                    <br />
                    <br />
                    Ajouter des boutons de partage à 5 endroits différents Les
                    besoins en matière de partage social varient selon les sites
                    Web, les pages et les messages. C'est pourquoi nous avons
                    inclus une large sélection d'emplacements que vous pouvez
                    choisir pour placer les boutons de partage.
                  </p>
                </div>
                {/* <!-- description - end --> */}
              </div>
